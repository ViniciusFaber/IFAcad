...
$ac_id = $_GET['ac_id']; // Recupera o ac_id da URL
$conexao = new Conexao();
...
$dadosAcademic = $academicDAO->getAcademicById($ac_id);
...
<head>
    ...
    <title>Atualização de Acadêmico</title>
                ...
                <div class="container">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fa fa-graduation-cap fa-lg" aria-hidden="true" style="color: #637B54;"></i> Editar acadêmico
                        </div>
                        <div class="card-body">
                            <form action="../Controller/update-academic.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small mb-1" for="ac_nome">Nome:</label>
                                            <input class="form-control" name="ac_nome" id="ac_nome" value="<?php echo $dadosAcademic['ac_nome']; ?>" type="text" placeholder="Nome" required/>
                                        </div>
                                    </div>
                                </div>        
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="ac_ra" id="ac_ra" value="<?php echo $dadosAcademic['ac_ra']; ?>" type="text" placeholder="Informe um RA" required/>
                                        </div>
                                    </div>
                                </div> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ac_curso" id="ac_curso" required>
                                                ...
                                                foreach ($courses as $course) {
                                                    $selected = ($course['c_id'] == $dadosAcademic['ac_curso']) ? "selected" : "";
                                                    echo "<option value=\"" . $course['c_id'] . "\" $selected>" . $course['c_id'] . " - " . $course['c_nome'] . "</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group mt-4 mb-0">
                                    ...
                                    <button type="submit" name="bnt-editar" class="btn btn-success">Atualizar</button>
                                </div>
                            </form>
                        </div>
                    </div>
