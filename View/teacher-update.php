...
$p_id = $_GET['p_id']; // Recupera o p_id da URL
...
if (isset($p_id)) {
    ...
    $dadosTeacher = $teacherDAO->getTeacherById($p_id); //Recupera os dados da tabela de professores

    if ($dadosTeacher !== null) {
        // Recupera o u_id usando o p_id
        $u_id = $teacherDAO->getUserIdByTeacherId($p_id);
        // Agora pode usar $u_id, se necessário        
    } else {
        echo "Professor não encontrado.";
    }
} else {
    echo "ID do professor não fornecido na URL.";
}
?>
<!DOCTYPE html>
<html lang="pt-br">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                    <div class="card-header"><i class="fa fa-university" aria-hidden="true" style="color: #637B54;"></i> Editar professor</div>
                    <div class="card-body">
                    <form action="../Controller/update-teacher.php" method="POST">
                        
                       <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="small mb-1" for="u_nome">Nome:</label>
                                        <input class="form-control" name="u_nome" id="u_nome" value="<?php echo $dadosTeacher['u_nome']; ?>" type="text" placeholder="Informe o nome do professor" required/>
                                    </div>
                                </div>
                            </div>                            
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="u_email" id="u_email" value="<?php echo $dadosTeacher['u_email']; ?>" type="text" placeholder="Informe o email do professor" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="u_senha" id="u_senha" value="<?php echo $dadosTeacher['u_senha']; ?>" type="text" placeholder="Informe uma senha" required/> 
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="p_ciap" id="p_ciap" value="<?php echo $dadosTeacher['p_ciap']; ?>" type="text" placeholder="Informe o SIAPE do professor" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="p_block" id="p_block">
                                        ...
                                        <option value="1" <?php if ($dadosTeacher['p_block'] == 1) echo "selected"; ?>>Ativo</option>
                                        <option value="0" <?php if ($dadosTeacher['p_block'] == 0) echo "selected"; ?>>Bloqueado</option>
                                    </select>
                                    </div>
                                </div>
                            </div>                            
